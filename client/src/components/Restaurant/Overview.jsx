    ...
    <>
      <div className="flex flex-col gap-5 md:flex-row relative">
        <div className="w-full md:w-8/12">
          ...
          <div className="my-4">
            ...
            <small className="text-gray-500">
              Exclusive of applicable taxes and charge, if any.
            </small>
          </div>
          <div className="flex flex-col-reverse">
            ...
            <div className="my-4 w-full md:hidden flex flex-col gap-4">
              <MapView
                title="McDonlad's"
                phno="+91960354285"
                mapLocation={getLatLong("17.5146576,78.3059869")}
                address="National Small Industries Cooperation, Trimulgherry - ECIL Rd, opposite Bata Showroom, Kapra, Secunderabad, Telangana 500062"
              />
            </div>
          </div>
        </div>
        <aside
          ...
          className="hidden md:flex md:w-4/12 static rounded-xl top-20 bg-white px-4 py-4 shadow-md flex-col gap-4"
        >
          <MapView
            title="McDonlad's"
            phno="+919060354285"
            mapLocation={getLatLong("17.5146576,78.3059869")}
            latAndLong = {"17.5146576,78.3059869"}
            address="National Small Industries Cooperation, Trimulgherry - ECIL Rd, opposite Bata Showroom, Kapra, Secunderabad, Telangana 500062"
          />
        </aside>
      </div>
