...
const OrderOnline = () => {
  ...
  const restaurant = useSelector((globaldata) =>
    globaldata.restaurant.selectedRestaurant.restaurant
  );
  useEffect(() => {
    restaurant &&
  ...
  <>
    <div className='w-full flex items-start'>
      ...
      <aside className='sticky-top-16 hidden md:flex flex-col gap-1 border-r overflow-y-scroll border-gray-200 h-screen w-1/4'>
        {menu.map((item,index) => (
          <MenuListContainer 
            {...item}
            key = {index}
      ...
      <div className='w-full px-3 md:w-3/4 h-screen sticky overflow-auto top-16'>
