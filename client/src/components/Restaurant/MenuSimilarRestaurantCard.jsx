    ...
    <div className='mx-2 my-2'>
      <div className='bg-white shadow rounded-md'>
        ...
        <div className='flex flex-col gap-2 p-3'>
          ...
          <div className='flex sm:flex-wrap items-center justify-start text-sm gap-4'>
            <span className='flex items-center justify-between text-sm gap-2'>
              <span className='flex  items-center text-sm gap-1 bg-green-700 text-white px-2 py-1 rounded'>
                3.9 <TiStar/>
              </span>
              Dining
            </span>
